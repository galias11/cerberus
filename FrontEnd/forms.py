...
class DocumentoForm(forms.ModelForm):
    ...
    class Meta:
        model = Documento
        fields = ['nombre_doc','titulo','descripcion_doc','documento']
        labels = {'nombre_doc':'', 'titulo':'','descripcion_doc':'','documento':''}
        widgets = {'nombre_doc':forms.HiddenInput({'class':'nombres'}),
                   ...
                   'documento':forms.FileInput({'accept':'.txt,.docx',
                                                'class':'documentos'})}

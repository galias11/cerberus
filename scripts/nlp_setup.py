...
nlp_admin = AdminModuleController()
...
nlp_admin.add_custom_entity('PER', 'Identifica personas')
nlp_admin.add_custom_entity('LOC', 'Identifica localizaciones')
nlp_admin.add_custom_entity('ORG', 'Identifica organizaciones u empresas')
nlp_admin.add_custom_entity('MISC', 'Identifica entidades miscelaneas')
nlp_admin.add_custom_entity('ME', 'Identifica entidades mal escritas')
nlp_admin.add_custom_entity('DRUG', 'Identifica entidades relacionadas con el narcotrafico')
examples = get_training_data_examples_list()
nlp_admin.submit_training_examples('modelo_drogas', examples)
examples_list = list([example['id'] for example in nlp_admin.get_submitted_training_examples('modelo_drogas', 'submitted')])
nlp_admin.approve_training_examples(examples_list)
nlp_admin.apply_approved_examples('modelo_drogas')
